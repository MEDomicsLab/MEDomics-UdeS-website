...
1. _Analyse d'image_ : l'extraction des caractéristiques radiomiques nous permet de mieux caractériser l'hétérogénéité  tumorale. Le logiciel [MEDiml]({{< relref "mediml" >}}) est la composante consacrée pour cette tâche.
